...
{
    // TODO
    // Looping through all candidate
    for (int i = 0; i < candidate_count; i++)
    {
        for (int j = i + 1; j < candidate_count; j++)
        {
            // Adding in the preferences array
...
void add_pairs(void)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        for (int j = i + 1; j < candidate_count; j++)
        {
            // Comparing two pairs of candidates
...
void lock_pairs(void)
{
    ...
    {
        // Lock pair if cycle function returns false
